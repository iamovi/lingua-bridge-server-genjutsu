...
A free, self-hostable **translation API** powered by [`google-translate-api-x`](https://github.com/AidanWelch/google-translate-api-x). No API keys required — it reverse-engineers Google Translate's public endpoint.
